...
output_MFL="${processed_dir}/08_ASVs_DADA2_blast_EA_riaz.txt"
#output_NCBI="${processed_dir}/08_ASVs_DADA2_blast_NCBI.txt"
...
# awk '($3 > 97)' "$output_MFL" > "${processed_dir}/08_ASVs_DADA2_blast_Metafishlib_97.txt"
